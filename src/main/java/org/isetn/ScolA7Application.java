...
public class ScolA7Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Classe c1 = classeRepository.save(new Classe(null,"DSI31",27,null));
		Classe c2 = classeRepository.save(new Classe(null,"DSI32",25,null));
		Classe c3 = classeRepository.save(new Classe(null,"DSI33",20,null));
